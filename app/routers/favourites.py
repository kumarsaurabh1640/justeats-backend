"""Favourite restaurants management endpoints.

Provides endpoints for customers to manage their favourite restaurants:
- List favourite restaurants
- Add/remove restaurants from favourites
"""
...
async def list_favourites(
    ...
    """Get all favourite restaurants for the current customer.

    Returns:
        List of favourite restaurant details.
    """
...
async def add_favourite(
    ...
    Raises:
        HTTPException: 404 if restaurant not found, 409 if already favourited.
    """
    profile = await get_customer_profile(current_user, db)
...
async def remove_favourite(
    ...
    Raises:
        HTTPException: 404 if restaurant not in favourites.
    """
    profile = await get_customer_profile(current_user, db)
