...
async def _enrich_cart_items(
    ...
    """Enrich cart items with menu item details and calculate subtotals.

    Args:
        items: List of cart items to enrich.
        db: Database session.

    Returns:
        List of CartItemOut with name, price, and subtotal.
    """
...
async def view_cart(
    ...
    Returns:
        List of cart items with details and calculated subtotals.
    """
...
async def add_to_cart(
    ...
    If the item already exists in cart, quantity is incremented.

    Args:
        payload: Menu item ID and quantity to add.

    Returns:
        The cart item with details.

    Raises:
        HTTPException: 404 if menu item not found or unavailable.
    """
    profile = await get_customer_profile(current_user, db)
...
async def update_cart_item(
    ...
    Args:
        item_id: The cart item's unique identifier.
        payload: New quantity for the item.

    Returns:
        The updated cart item with recalculated subtotal.
